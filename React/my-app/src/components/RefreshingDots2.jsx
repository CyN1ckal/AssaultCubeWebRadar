...
// Function for coloring the dot based on team id
...
function RefreshingDots2() {
  ...
  useEffect(() => {
    ...
    GetData("http://10.0.0.3:4000/get").then((response) => {
      JsonString = response;
  ...
  const listItems = PositionArray.map((Position, i) => (
    <Circle
      key={i} //Replace this with an actual key
...
export default RefreshingDots2;
